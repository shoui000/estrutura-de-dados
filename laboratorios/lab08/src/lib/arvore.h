...
// cria uma árvore com a informação do nó raiz c, e com subárvore esquerda e a
// subárvore direita
Arv *arv_cria(Aluno *c, Arv *e, Arv *d);

// insere na arvore ordenado por matricula (a esquerda fica menores, a direita fica maiores)
