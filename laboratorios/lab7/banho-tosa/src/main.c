//
//  Este testa TODAS as funcionalidades
...
int main(int argc, const char * argv[]) {
    ...
    cadastraGato(loja, branca); // BRAVA
    cadastraGato(loja, ronaldo); // MANSO
    
    cadastraCachorro(loja, iris); // BRAVA
    cadastraCachorro(loja, bob); // MANSO
    cadastraCachorro(loja, baby); // MANSO
